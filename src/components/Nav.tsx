  ...
  return (
    ...
    >
      <path
        fill="#646464"
        fillRule="evenodd"
        d="M8.75 16.384a7.083 7.083 0 115.563-2.699l3.776 3.776a.833.833 0 11-1.178 1.178l-3.776-3.775a7.053 7.053 0 01-4.385 1.52zm3.777-3.2a5.417 5.417 0 11.107-.107.858.858 0 00-.107.106z"
        clipRule="evenodd"
      ></path>
      <mask
        id="mask0_12050_35843"
        style={{ maskType: "luminance" }}
        width="18"
        height="17"
        x="1"
